 ...
 *
 * <p>
 * Expose une méthode {@link #ajouterSiteDemo()} qui ajoute dynamiquement une
 * nouvelle {@link
 * SiteCarte} (composant écrit à l'exercice 5) dans la liste. Le contenu des
 * cartes est généré
 * automatiquement à partir d'un compteur interne, pour les besoins de la démo.
 *
 * <p>
 * Aucun lien direct avec l'en-tête : c'est le contrôleur parent qui orchestre
 * les deux.
 */
public class ListeSitesController {

  @FXML
  private VBox conteneurCartes;

  private int compteurDemo = 0;

  /**
   * Ajoute une carte de site dans la liste avec des données démonstratives qui
   * varient à chaque
